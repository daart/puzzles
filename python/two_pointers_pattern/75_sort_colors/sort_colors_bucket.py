...
nums and on each occurrence we will increment corresponding value in counters arr by index. After that we have to refill nums array. We will need 
...
of times this digit occurred in the nums array, so we will update nums arr by insertion index (m) and increase that insertion index m +=1 
"""
